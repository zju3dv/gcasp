...
def plot_mAP(iou_aps, pose_aps, out_dir, iou_thres_list, degree_thres_list, shift_thres_list):
    ...
    # IoU subplot
    ax_iou.set_title('3D IoU', fontsize=15)
    ax_iou.set_ylabel('Average Precision', fontsize=15)
    ax_iou.set_ylim(0, 100)
    ax_iou.set_xlabel('Percent', fontsize=15)
    ax_iou.set_xlim(0, 100)
    ax_iou.xaxis.set_ticks([0, 25, 50, 75, 100], fontsize=15)
    ax_iou.grid()
    ax_iou.tick_params(labelsize=15)
